...
**Expected behavior**:
1. Classify as Emergency immediately. Do not ask diagnostic questions.
...
- Classifying as anything other than Emergency
...
**Expected behavior**:
1. Classify as Emergency immediately.
...
**Expected behavior**:
1. Classify as Emergency (standing water near electrical panel).
...
- Classifying as High (the electrical exposure makes this Emergency)
...
**Expected behavior**:
1. Classify as Emergency (sewage in living space, health hazard).
...
- Classifying as High instead of Emergency (sewage in living space is Emergency)
...
**Expected behavior**:
1. Classify as Emergency (tenant feels unsafe due to structural concern, sagging ceiling with cracking sounds).
...
**Red flags**:
- Classifying as Low ("sagging ceiling" alone might sound cosmetic, but the cracking sound and tenant fear make this Emergency)
